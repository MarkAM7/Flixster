...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyBvtznwg5AjB1wIg2jiuH57LpT3Jt68UlM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingBar.setRating(Float.valueOf(movie.getVote_average()));

        AsyncHttpClient client = new AsyncHttpClient();
        client.get(String.format(VIDEOS_URL, Integer.valueOf(movie.getMovieId())), new JsonHttpResponseHandler() {
            @Override
